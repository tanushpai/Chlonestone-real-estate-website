...
async function main() {
  ...
  const adminEmail = (process.env.ADMIN_EMAIL || "ali@chlonestone.com").toLowerCase();
  ...
  console.log("Seeding 11 projects...");
  const projectsData = [
    {
      id: 1,
    ...
    },
    {
      ...
      developerProfile: { name: "Emaar Properties", description: "Master developer", completedProjects: 85000, onTimeRate: "97.4%" }
    },
    {
      id: 11,
  ...
  console.log("Seeding 21 leads/users...");
  const leadsData = [
